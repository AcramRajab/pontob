...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    step: "Planejamento → Visão Anual",
    description: "Antes de qualquer coisa, acesse Planejamento → Visão Anual e registre os números atuais e as metas de final de cada trimestre para os 3 KRIs da rede: Corretores ativos, CREs (contratos de representação) e VGH (volume de vendas em R$).",
