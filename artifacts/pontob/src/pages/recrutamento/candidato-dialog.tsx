...
import { Trash2, ChevronLeft, ChevronRight, Phone, Mail, MessageCircle, Loader2, Plus } from "lucide-react";
              ...
              {candidato.phone && (
                <div className="flex items-center gap-1.5">
                  <div>
                    ...
                    <p className="font-medium text-xs">{candidato.phone}</p>
                  </div>
                </div>
              )}
              {candidato.email && (
              ...
              {candidato.stage === "entrevista" && canWrite && (
                <div className="flex-1">
                  ...
                  <Input
                    ...
                    defaultValue={formatDateInput(candidato.interviewAt)}
                    onChange={(e) => {
                      onSetInterviewDate(candidato.id, e.target.value);
                      onUpdate({ ...candidato, interviewAt: e.target.value });
                    }}
                  />
                </div>
              )}
                ...
                <div className="flex gap-2">
                  {["avancar", "aguardar", "rejeitar"].map((rec) => (
                    <button
                      ...
                      onClick={() => {
                        onSetRecommendation(candidato.id, rec);
                        onUpdate({ ...candidato, recommendation: rec });
                      }}
                    >
                      {recLabel[rec]}
                    </button>
              ...
              {canWrite && (
                <div className="flex gap-2 mb-3">
                  ...
                  <Input
                    ...
                    placeholder="Ex: Ligou às 14h, aguarda retorno..."
                    value={actDesc}
                  ...
                  <Button
                    ...
                    disabled={!actDesc.trim() || addAtividade.isPending}
                  >
